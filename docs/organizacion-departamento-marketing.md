...
>
> Última actualización: 2026-07-21 · Responsable del doc: **Pico** (Pilar — RevOps / Marketing Automation)
...
| **Pico (Pilar)** | **CRM, automatización y sistema de datos** | HubSpot, automatizaciones, **calidad del dato** y montar el **sistema de reporting/tracking**. Owner del lead scoring (heredado). |
| **Víctor Molla** | Sponsor / dirección | Visión global del squad; sparring mensual. Cada vez más absorbido por fundraising y Brain. |

**Misión de Pico (declarada):** que **en septiembre exista un sistema que traccione** y permita tomar decisiones sobre los datos, que aporte valor y que el proceso funcione. No tiene que estar al 100% ni ser perfecto — **tiene que funcionar**.

### 1.2 Herramientas y reporting
- **HubSpot** como CRM y centro de automatización (owner: Pico).
...
- **Lead scoring**: modelo **fit score + hit score**, umbral ~50 puntos para MQL (formalizado 20-jul). Ownership: Pico.
...
Regla de oro: **el reporting se lee antes** del Syncro (Pico comparte highlights), para no quemar la reunión en revisar números.
...
1. **Sistema de datos que funcione (Pico)** — objetivo ancla del trimestre: en septiembre, tracking y reporting fiables para decidir con datos.
...
### ⚙️ Pico — CRM, automatización y sistema de datos
...
- [ ] Aplicar la cadencia de 2.1 (Syncro 60 min con hard stop + Marketing Review mensual). — *Owner: Marisa + Pico*
- [ ] Reporting compartido y leído antes del Syncro. — *Owner: Pico*
...
- [ ] Reflejar los KPIs en `dashboard_ejecutivo` como panel de seguimiento. — *Owner: Pico*
...
- [ ] Traspasar formalmente a Pico lo que llevaba Jonathan del CRM/scoring; el paid completo pasa a Melero. — *Owner: Pico + Melero*
...
| Analítica y atribución (GA4, tráfico) | Marina | Pico (CRM/atribución) |
| Paid (Google + Social Ads) | Alejandro Melero | Pico (scoring/atribución) |
| CRM HubSpot, automatización, calidad del dato | Pico | Todo el equipo |
| Sistema de reporting / tracking (hito septiembre) | Pico | Marina (GA4), Víctor |
